 ...
 * @author janto
 */
@Path("ValidarPersonaSinAutenticar")
public class ValidarPersonaSinAutenticarResource {
...
@Context
     ...
     */
    public ValidarPersonaSinAutenticarResource() {
    }
   ...
   // @Consumes(MediaType.TEXT_PLAIN)
    ...
    public String ValPersona(@PathParam("nombre") String nombre,@PathParam("correo") String correo,@PathParam("telefono") int telefono) {
    try {
